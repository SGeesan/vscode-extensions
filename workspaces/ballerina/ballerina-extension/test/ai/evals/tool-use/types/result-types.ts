...
export interface ToolEvalResult {
    readonly toolName: string;
    readonly efficiencyScore: number; // 0 to 1
    readonly isUnderused: boolean;
    readonly isOverused: boolean;
    readonly isExpectedToBeUsed: boolean;
    readonly successCount: number;
    readonly totalCalls: number;
}

export interface AggregatedToolEvalResult {
    readonly toolName: string;
    readonly averageEfficiencyScore: number;
    readonly averageSuccessRate: number; // 0 to 1, average of per-case successCount/totalCalls for cases with totalCalls > 0
    readonly toolUsageRecall: number; // 0 to 1
    readonly notOverusedCaseRate: number; // 0 to 1
    readonly totalCases: number;
    readonly expectedUsageCases: number;
    readonly notUnderusedCases: number;
    readonly notOverusedCases: number;
}
...
export interface UsecaseResult {
    ...
    readonly toolEvalResults?: ToolEvalResult[];
...
export interface Summary {
    ...
    readonly aggregatedToolEvalResults?: readonly AggregatedToolEvalResult[];
...
export interface UsecaseCompact {
    ...
    readonly iteration?: number;
    readonly toolEvents?: readonly ToolEvent[];
    readonly toolEvalResults?: readonly ToolEvalResult[];
    readonly usage?: {
